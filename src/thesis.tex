...
\title{Pengoptimalan \textit{Highly concurrent read and write transaction system} pada PostgreSQL dengan \textit{Event-Based System} dan \textit{Streaming Database} untuk kasus \textit{Ticketing System}}
\date{}
\author{
  Akbar Maulana Ridho \\
  NIM: 13521093
