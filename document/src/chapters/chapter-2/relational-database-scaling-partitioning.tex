...
\begin{enumerate}
    \item Partisi berdasarkan kunci, seperti judul buku yang berawalan A-E, F-J, dan seterusnya. Meskipun begitu, perlu diiperhatikan apakah distribusi kunci tersebar secara merata. Gambar \ref{fig:partition-by-key-range} menunjukkan ilustrasi pemartisian berdasarkan rentang kunci.
          \pagebreak
          \begin{figure}[htbp]
              \centering
    ...
    \item Partisi berdasarkan hash kunci. Fungsi hash yang baik dapat mengubah distribusi kunci yang tidak simetris menjadi merata. Gambar \ref{fig:partition-by-hash} menunjukkan ilustrasi pemartisian berdasarkan kunci hash.
          \begin{figure}[htbp]
              \centering
