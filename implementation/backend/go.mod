...
require (
	...
	github.com/testcontainers/testcontainers-go/modules/rabbitmq v0.36.0 // indirect
	github.com/testcontainers/testcontainers-go/modules/yugabytedb v0.36.0 // indirect
