...
func NewPayInvoiceRequest(mode string) *PayInvoiceRequest {
...
func (o *PayInvoiceRequest) GetMode() string {
	if o == nil {
		var ret string
		return ret
	}
...
func (o *PayInvoiceRequest) GetModeOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Mode, true
...
func (o *PayInvoiceRequest) SetMode(v string) {
	o.Mode = v
}
